...
func (x *RegisterRequest) GetPassowrd() string {
	if x != nil {
		return x.Passowrd
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\bpassowrd\x18\x02 \x01(\tR\bpassowrd\"+\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x14Z\x12eldar.sso.v1;ssov1b\x06proto3"
